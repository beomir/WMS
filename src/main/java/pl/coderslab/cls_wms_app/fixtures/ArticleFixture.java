...
public class ArticleFixture {
    ...
    private List<Article> articleList = Arrays.asList(
            new Article(null, 1234567890123455L, "bicycle",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",97,20,185,358900,15.00,null,false,null),
            new Article(null, 1234567890123456L, "sandbag",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",60,40,30,72000,30.00,null,false,null),
            new Article(null, 1234567890123457L, "cement",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",60,40,30,72000,35.00,null,false,null),
            new Article(null, 1234567890123458L, "glue",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",40,20,20,16000,20.00,null,false,null),
            new Article(null, 1234567890123459L, "wheel",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",50,50,20,50000,15.00,null,false,null),
            new Article(null, 1234567890123460L, "electric cables",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",500,5,5,12500,10.00,null,false,null),
            new Article(null, 3234567890123458L, "tv",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",150,50,15,112500,15.00,null,false,null),
            new Article(null, 3234567890123458L, "laptop",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",30,15,5,2250,1.00,null,false,null),
            new Article(null, 4234567890123458L, "screw 12mm",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",5,1,1,5,0.30,null,false,null),
            new Article(null, 7234567890123458L, "propeller",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",800,100,50,4000000,300,null,false,null),
            new Article(null, 5234567890123458L, "trousers",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",120,50,10,60000,1.40,null,false,null),
            new Article(null, 6234567890123458L, "socks",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",10,40,7,2800,0.30,null,false,null),
            new Article(null, 5234567890123423L, "jewelry",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",5,5,5,125,1.00,null,false,null),
            new Article(null, 1234567890123475L, "mini-parts",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",10,3,3,90,2.00,null,false,null),
            new Article(null, 9234567890123455L, "wooden box",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",10,10,10,1000,3.30,null,false,null),
            new Article(null, 1122334455747896L, "table",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",100,230,130,2990000,17.80,null,true,null),
            new Article(null, 7122334455747896L, "screw 8mm",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",5,1,1,5,0.02,null,true,null),
            new Article(null, 7122334455747897L, "screw 13mm",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",5,1,1,5,0.02,null,true,null),
            new Article(null, 7122334455747996L, "metal buckles",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",3,3,0.1,0.9,0.10,null,true,null),
            new Article(null, 5122334455747896L, "non-slip pads",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",1,10,10,100,0.10,null,true,null),
            new Article(null, 9122334455747196L, "wooden table legs 80x15x15cm color light pine",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",80,15,15,18000,2.00,null,true,null),
            new Article(null, 9122334455747296L, "table top 220x120x10cm color light pine",null,null,null, TimeUtils.timeNowLong(),TimeUtils.timeNowLong(),true,"system",220,120,10,264000,8.50,null,true,null)

    );

    @Autowired
    public ArticleFixture(ArticleService articleService, CompanyService companyService, ArticleTypesService articleTypesService, ProductionArticleService productionArticleService) {
