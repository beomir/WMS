...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/templates/**","/shipment", "/shipment/**").hasAnyRole("USER", "ADMIN","SHIPMENT_USER")
                .antMatchers("/templates/**","/reception", "/reception/**").hasAnyRole("USER", "ADMIN","RECEPTION_USER")
                .antMatchers("/templates/**","/storage", "/storage/**").hasAnyRole("USER", "ADMIN","STOCK_USER")
                .antMatchers("/templates/**","/config", "/config/**").hasRole("ADMIN")
                .antMatchers("/templates/**","/user", "/user/**").hasAnyRole("USER","ADMIN")
